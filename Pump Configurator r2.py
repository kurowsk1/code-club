...
# CREATE A LIST OF BUTTONS WITH IDENTICAL PROPERTIES FOR THE FIRST FRAME
frame_1_button_list = [btn_pureTec, btn_chemTec, btn_labTec, btn_mabTec, btn_filterTec,  btn_ftPlus]
frame_1_button_labels = ["PureTec", "ChemTec", "LabTec", "MABTec", "FilterTec", "FilterTec Plus"]

for a in range (btn_pureTec, len(frame_1_button_list)):
    frame_1_button_list = Button(oneFrame, text=(frame_1_button_labels), fg="blue")
    frame_1_button_list.pack(side=LEFT)
